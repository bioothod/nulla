...
private:
	...
	void on_write_partial(const elliptics::sync_write_result &result, const elliptics::error_info &error) {
		if (error) {
	...
	void on_write_finished(const elliptics::sync_write_result &result,
